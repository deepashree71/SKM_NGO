...
// so /api/v1 routes automatically go to the backend serverless function.
// VITE_API_BASE_URL should be set to https://your-app.vercel.app/api/v1 in Vercel env vars.
