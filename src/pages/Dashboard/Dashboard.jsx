...
export default function Dashboard() {
  ...
  const handleDownloadCert = async (id, name) => {
    ...
    try {
      ...
      triggerPdfDownload(new Blob([res.data], { type: 'application/pdf' }), `certificate-${name}.pdf`)
      toast.success('Certificate downloaded!', { id: toastId })
    } catch {
      toast.error('Certificate download failed. Please try again.', { id: toastId })
    }
  }
  ...
  const handleDownloadReceipt = async (id) => {
    ...
    try {
      ...
      triggerPdfDownload(new Blob([res.data], { type: 'application/pdf' }), `donation-receipt.pdf`)
      toast.success('Receipt downloaded!', { id: toastId })
    } catch {
      toast.error('Receipt download failed. Please try again.', { id: toastId })
    }
  }
  ...
  const handleDownloadIDCard = async () => {
    ...
    try {
      ...
      triggerPdfDownload(new Blob([res.data], { type: 'application/pdf' }), `volunteer-id-card.pdf`)
      toast.success('ID Card downloaded!', { id: toastId })
    } catch {
      toast.error('ID Card generation failed. Please contact admin.', { id: toastId })
    }
  }
