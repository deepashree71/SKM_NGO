      ...
      <header style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 1000, boxShadow: scrolled ? '0 3px 24px rgba(0,0,0,0.22)' : '0 1px 6px rgba(0,0,0,0.08)', transition: 'box-shadow 0.3s' }}>
        ...
        {mobileOpen && (
          <div style={{ background: '#0D1B3E', borderTop: '1px solid rgba(255,255,255,0.1)', maxHeight: 'calc(100vh - 100px)', overflowY: 'auto' }}>
            ...
            <div style={{ padding: '14px 20px', borderTop: '1px solid rgba(255,255,255,0.12)', display: 'flex', flexWrap: 'wrap', gap: 8 }}>
              {LANG_OPTIONS.map(l => (
                <button
                  key={l.code}
                  ...
                  style={{
                    ...
                    border: lang === l.code ? '2px solid #f5d87e' : '1px solid rgba(255,255,255,0.25)',
                    background: lang === l.code ? 'rgba(245,216,126,0.18)' : 'rgba(255,255,255,0.07)',
                    color: lang === l.code ? '#f5d87e' : 'rgba(255,255,255,0.75)',
                    transition: 'all .15s',
                  }}
                >
                  {LANG_NATIVE[l.code]}
