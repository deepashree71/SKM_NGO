...
// ─── Ensure storage dirs exist (safe for Vercel read-only fs) ─────────────────
try {
  ...
  // On Vercel the filesystem is read-only — that's fine, PDFs go via buffer
  console.log('Storage dirs skipped (read-only fs):', e.message)
}
